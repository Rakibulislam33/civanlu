 <x-guest-layout>
    <div class="relative z-10 pt-52 pb-64 bg-cover bg-center" style="background-image: url(/img/hero-bg.jpg)">
        ...
        <div class="container relative z-20 text-white text-center text-2xl">
            <h2 class="font-bold text-5xl mb-5">Lorem ipsum dolor sit, </br> consectetur adipisicing elit. </h2>
            <p>Cupiditate molestiae sed corporis placeat id, quae, beatae cumque </p>
        </div>
    </div>
...
<div class="py-20 text-center">
        <div class="container">
        <h2 class="font-bold text-4xl mb-6">Lorem ipsum, dolor sit amet consectetur </br> adipisicing elit. Labore sed quos eum quod <span class="underline">dignissimos</span></h2>
            <p class=" text-gray-500 text-2xl font-bold mb-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore, quo.</p>

            <a class=" border-2 border-gray-700 rounded-2xl text-xl px-8 py-3 inline-block" href=""> Start the search</a>


            <h2 class="font-bold text-4xl mb-6 mt-12">Lorem ipsum, dolor sit amet consectetur </br> adipisicing elit. Labore sed quos?</h2>
    ...
    <div class="container text-center pt-14">
        ...
        <div class="relative mt-10 mb-14 bg-cover rounded-xl py-24 bg-center"
             style="background-image: url('/img/bg-hero.jfif')">
    ...
    <div class="container pt-14">
        <div class="flex justify-between ">
            ...
            <div class="flex-1 ml-10">
                <img class="rounded" src="/img/bg-hero.jfif" alt="">
            </div>
        </div>
    </div>
    <div class="container pt-14">
